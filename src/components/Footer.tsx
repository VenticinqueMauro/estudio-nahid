...
export default function Footer() {
    return (
        <motion.footer
            ...
            className="absolute bottom-0  container flex items-center w-full lg:justify-center px-3 pb-5 "
        >
            <div className="flex flex-col lg:flex-row  lg:items-center uppercase gap-2 lg:gap-10 text-xs lg:text-sm list-none text-zinc-400">
                <a
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-map-pin pb-1 group-hover:text-cyan-500 "><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
